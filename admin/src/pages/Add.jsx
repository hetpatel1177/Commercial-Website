    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' >
      ...
      <div className='flex flex-col sm:flex-row gap-2w-full sm:gap-8'>
        <div>
          ...
          <select onChange={(e)=> setCategory(e.target.value)} value={category} className='w-full py-2 px-3'>
        ...
        <div>
          ...
          <select onChange={(e)=> setSubcategory(e.target.value)} value={subcategory}  className='w-full py-2 px-3'>
        ...
        <div>
          ...
          <input onChange={(e)=> setPrice(e.target.value)} value={price} className='w-full py-2 px-3 sm:w-[120px]' type="number" placeholder='25' />
        </div>
      </div>
      <div>
        <p>Product Sizes</p>
