      ...
      <div className='mt-8 '>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border p2- px-3 cursor-pointer border-gray-200'>
              <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-200 ${method === 'stripe' ? 'bg-green-400' : ''} `}></p>
              <img className='h-5 mx-4 ' src={assets.stripe_logo} alt="" />
            </div>
            <div onClick={() => setMethod('razorpay')} className='flex items-center gap-3 border p2- px-3 cursor-pointer border-gray-200'>
              <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-200 ${method === 'razorpay' ? 'bg-green-400' : ''}`}></p>
              <img className='h-5 mx-4 ' src={assets.razorpay_logo} alt="" />
            </div>
            <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border p2- px-3 cursor-pointer border-gray-200'>
              <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-200 border-gray-200 ${method === 'cod' ? 'bg-green-400' : ''}`}></p>
